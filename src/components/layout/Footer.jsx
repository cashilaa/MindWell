...
import logo from '../../assets/logo.png'; // updated path to logo
      ...
      <div className="container mx-auto py-8 px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/quiz" className="text-gray-600 hover:text-[#977669]">
                  Take Quiz
                </Link>
              </li>
              <li>
                <Link to="/therapists" className="text-gray-600 hover:text-[#977669]">
                  Find Therapists
                </Link>
              </li>
              <li>
                <Link to="/appointments" className="text-gray-600 hover:text-[#977669]">
                  Book Appointment
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li className="flex space-x-4 mt-4">
                ...
                <a href="#" className="text-gray-600 hover:text-[#FFC499]">
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          <p className="text-center text-gray-600">
            &copy; {new Date().getFullYear()} Tryve. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
