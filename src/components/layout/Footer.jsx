      ...
      <div className="container mx-auto py-8 px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-primary-600">MindWell</h3>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/quiz" className="text-gray-600 hover:text-primary-600">
                  Take Quiz
                </Link>
              </li>
              <li>
                <Link to="/therapists" className="text-gray-600 hover:text-primary-600">
                  Find Therapists
                </Link>
              </li>
              <li>
